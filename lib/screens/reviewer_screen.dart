...
import 'competency_details_screen.dart';
...
class _ReviewerScreenState extends State<ReviewerScreen> {
  ...
  Widget _buildCompetencyCard(Map<String, dynamic> comp, bool isDark, Color themeColor) {
    final title = comp['name']?.toString() ?? 'Competency';
    final code = comp['code']?.toString() ?? '';
          ...
          onTap: () {
            ...
            if (compId > 0) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => CompetencyDetailsScreen(competencyId: compId),
                ),
              );
            }
          },
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Icon(
                          ...
                          color: isDark ? themeColor : themeColor.withOpacity(0.9),
                          size: 30,
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Icon(Icons.quiz_outlined, size: 14, color: subtitleColor),
